package com.arunsudharsan.socialnetwork.Login;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mProgressBar = (ProgressBar) findViewById(R.id.progressbarrequestforloginscreen);
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    try {
                                        if (user.isEmailVerified()) {
                                            ...
                                            Toast.makeText(mContext, "Check email inobx", Toast.LENGTH_SHORT).show();
                                        }
    ...
    private void setupFirebaseAuth() {
        ...
        TextView linkSignUp = (TextView) findViewById(R.id.loginlink);
